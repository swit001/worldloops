import type { CapabilityBoundary, CapabilityRule } from '../types/capabilityBoundary';

const allowed: CapabilityRule[] = [
  {
    name: 'readSignals',
    allowed: true,
    boundary: 'read_only',
...
export function getCapabilityBoundary(): CapabilityBoundary {
  return {
    externalWrite: false,
