...
function main() {
    ...
    const contract = (0, executionContracts_1.findExecutionContractById)(contractId);
    if (!contract) {
        const all = (0, executionContracts_1.listExecutionContracts)();
        printJson({
            ok: false,
            error: {
...
main();
//# sourceMappingURL=contractShow.js.map